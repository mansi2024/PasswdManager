...
@app.route('/')
def index():
    return render_template('passwdhome.html')
@app.route('/passwdhome')
def passwdhome():
    # home page code goes here.
    return render_template('passwdhome.html')

@app.route('/passwdregister', methods=['GET', 'POST'])
def passwdregister():
    # below line does
    # if current user is logged in and user tries to go to register page it will redirect to home.
    if current_user.is_authenticated:
        return redirect(url_for('passwdhome'))
    ...
    return render_template('passwdregister.html', title=page_title, form=form)


@app.route('/passwdlogin', methods=['GET', 'POST'])
def passwdlogin():
    # below line does
    ...
    return render_template('passwdlogin.html', title=page_title, form=form)
